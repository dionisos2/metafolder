...
//!
//! Deliberately a copy of `crates/daemon/tests/common/mod.rs`: each `tests/`
//! tree is its own crate, and a test helper is not worth a shared crate in the
//! build graph. Keep the two in step.
//!
